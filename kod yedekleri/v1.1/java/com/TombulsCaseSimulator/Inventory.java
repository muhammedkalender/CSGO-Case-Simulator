...
public class Inventory extends AppCompatActivity
    ...
    public void buildPage(){
        ...
        try {
            ...
            while (cursorInventory.moveToNext()){
                ...
                _child.setLayoutParams(new TableLayout.LayoutParams(70*toolBox._pixelSize, ViewGroup.LayoutParams.WRAP_CONTENT, 1f));
                    ...
                    public void onClick(View v) {
                        ...
                        oButtonSell.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if(finalIntIndex < 4){
                                    oLLArea1.removeView(_child);
                                }else if(finalIntIndex < 8){
                                    oLLArea2.removeView(_child);
                                }else if(finalIntIndex < 12){
                                    oLLArea3.removeView(_child);
                                }
            ...
            if(cursorInventory.getCount() != 12){
                if(oLLArea3.getChildCount() != 4){
                    while (oLLArea3.getChildCount() != 4){
                        LinearLayout a = new LinearLayout(this);
                        a.setLayoutParams(new TableLayout.LayoutParams(70*toolBox._pixelSize, 10, 1f));
                        oLLArea3.addView(a);
                    }
                }

                if(oLLArea2.getChildCount() != 4){
                    while (oLLArea2.getChildCount() != 4){
                        LinearLayout a = new LinearLayout(this);
                        a.setLayoutParams(new TableLayout.LayoutParams(70*toolBox._pixelSize, 10, 1f));
                        oLLArea2.addView(a);
                    }
                ...
                while (oLLArea1.getChildCount() != 4){
                    LinearLayout a = new LinearLayout(this);
                    a.setLayoutParams(new TableLayout.LayoutParams(70*toolBox._pixelSize, 10, 1f));
                    oLLArea1.addView(a);
                }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        toolBox.navigationSelect(item.getItemId());
