...
btnFunction.setAlpha(0.7f);
    ...
    public void playFlip(){
        ...
        if(txtValue.getText().length() != 0){
            valueTemp = Integer.parseInt(txtValue.getText().toString());
        }

        final int value = valueTemp;
        ...
        new CountDownTimer(2000,250){
            ...
            public void onFinish() {
                ...
                LinearLayout lyResult = (LinearLayout)findViewById(R.id.lyResult);
                ...
                ToolClass toolBox = new ToolClass(getApplicationContext());

                TextView _play = toolBox.customTextView(_choose,-1,12,true);
                TextView _win = toolBox.customTextView(_winString, -1,12,true);
                TextView _value = toolBox.customTextView(String.valueOf(_subValue), -1,12,true);

                _play.setBackgroundColor(getResources().getColor(_color));
                _win.setBackgroundColor(getResources().getColor(_color));
                _value.setBackgroundColor(getResources().getColor(_color));
