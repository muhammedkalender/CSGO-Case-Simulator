...
public class TradeUp extends AppCompatActivity
    ...
    GridLayout oGridLayoutOptions = null, oGridLayoutInventory = null, oGridLayoutSelected = null;
    ...
    LinearLayout oLLInventoryFather = null, oLLGainItem = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oGridLayoutOptions = (GridLayout)findViewById(R.id.oGLOptions);
        oGridLayoutSelected = (GridLayout)findViewById(R.id.oGLSelected);
    ...
    public void buildOptions(){
        ...
        while (i != 5){
            ...
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(100*toolBox._pixelSize, 85*toolBox._pixelSize);
            ...
            oGridLayoutOptions.addView(linearLayoutNormal);
            oGridLayoutOptions.addView(linearLayoutStattrak);
    ...
    public void buildInventory(int Color, int Stattrak, boolean pageChance){
        ...
        if(!pageChance){
            oGridLayoutSelected.removeAllViews();
            _db.clearTradeUp();
        }
        ...
        while (_cr.moveToNext()){
            ...
            _selecChild.setLayoutParams(new LinearLayout.LayoutParams(75*toolBox._pixelSize,95*toolBox._pixelSize));
            ...
            _selecChild.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    txtChecked.setVisibility(View.INVISIBLE);
                    oGridLayoutSelected.removeView(_selecChild);
                    intSelectCount--;
            ...
            _child.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(Integer.parseInt(_child.getTag().toString().split(",")[0]) == 0){
                        ...
                        oGridLayoutSelected.addView(_selecChild);
    ...
    private void playGame(){
        ...
        if(toolBox.gainXP(1)){
            Intent _levleUp = new Intent(this,LevelUp.class);
            startActivity(_levleUp);
        }
