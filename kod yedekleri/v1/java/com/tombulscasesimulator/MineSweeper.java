...
public class MineSweeper extends AppCompatActivity
    ...
    public void mineFinish(){
        ...
        LinearLayout father = (LinearLayout)findViewById(R.id.list_result);
        ...
        TextView _txt = toolBox.customTextView(_text,-1,16,false);

        _txt.setTextColor(getResources().getColor(_color));
