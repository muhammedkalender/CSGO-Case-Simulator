...
public class OpenCase extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_mainmenu) {
            ...
            _intent = new Intent(this, Inventory.class);
            startActivity(_intent);
    ...
    public void listingItem(int ID){
        ...
        GridLayout _father = (GridLayout)findViewById(R.id.itemListChild);
        ...
        while (_cr.moveToNext()){
            ...
            addItemList(_cr.getString(_cr.getColumnIndex("ID")), _cr.getString(_cr.getColumnIndex("Skin")), _cr.getString(_cr.getColumnIndex("Name")),_color,0);
        }

        addItemList("special", getString(R.string.rare), getString(R.string._specialItem),6, _caseSpecial);
    ...
    public  void  addItemList(String ID, String Weapon, String Skin, int Color, int Special){
        try{
            ...
            if(ID == "special"){
                _skin.setImageBitmap(getBitmap("special/special"+Special+".png",75*pixels, 50*pixels));
            }else{
                _skin.setImageBitmap(getBitmap("item/"+ID+".png", 75*pixels, 50*pixels)); // TODO STİCKER DESTEKLEMİYO WEAPON -> ITEM OLCAK
            }
            int _imageSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 70, getResources().getDisplayMetrics());

            LinearLayout.LayoutParams _param1 = new LinearLayout.LayoutParams(_imageSize,(int)(_imageSize*0.8));
    ...
    public void listingCases(){
        ...
        try {
            ...
            GridLayout _father = (GridLayout) findViewById(R.id.caseListChild);
            ...
            while (_cr.moveToNext()){
                ...
                LinearLayout.LayoutParams _size = new LinearLayout.LayoutParams(pixels*70, pixels*70);
                _size.setMargins(pixels/15, pixels/15, pixels/15, pixels/15);
    ...
    public void gainItem(int ID,int Stattrak, int Quality, int Color){
        try{
            ...
            ImageView _objectItemSkin = (ImageView)findViewById(R.id.gainImage);
            ImageView _objectSkinBack = (ImageView)findViewById(R.id.gainImageBack);
    ...
    public void openCase(){
        ...
        for(int i = 0;i < 36; i++) {
            ...
            if (_itemId == 0) {
                ...
                _itemColor = R.string._specialItem;
            }else{
                _itemName += _tempName;
                _itemSkin += _tempSkin;
            }
