...
public class DataBase extends SQLiteOpenHelper {
    ...
    public int[] avaibleQuality(int ID, int Quality, int StatSou){;
        ...
        while (Integer.parseInt(priceQuery.split("_")[Quality+(StatSou*5)]) == -1 || Integer.parseInt(priceQuery.split("_")[Quality+(StatSou*5)]) == 0 && intTry != 10){
            if(Quality == 5){
                Quality = 0;
            }
   ...
   //endregion
    ...
    public void updateCasePrice(int intID, int intCasePrice){
        addQuery("UPDATE cases SET Price = "+intCasePrice+" WHERE ID = "+intID);
    }
