...
public class Jackpot extends AppCompatActivity
    ...
    RelativeLayout oRLScroolFather = null, oRLResultFather = null;
    View.OnClickListener clickPlay = null, clickConfirm = null;
    String winQuery = "";
    ImageView oIVStatus = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oRLResultFather = (RelativeLayout)findViewById(R.id.resultFather);

        oGLInventory = (GridLayout)findViewById(R.id.glInventory);
        //_db.Update(); //todo

        oIVStatus = (ImageView)findViewById(R.id.imgStatus);
        ...
        oButtonAddItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                oIVStatus.setImageResource(R.mipmap.ctt);
                oIVStatus.clearAnimation();
                buildPage();
            }
        });
        ...
        intMaxGain = _db.getStatic("JACKPOT_MAX_GAIN");
        intMaxPot = _db.getStatic("JACKPOT_MAX_POT");
    }
    ...
    public void buildClick(){
        ...
        clickConfirm = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                oButtonAddItem.setClickable(true);
                oButtonAddItem.setAlpha(1);
                oRLResultFather.setVisibility(View.VISIBLE);
            }
        };
        ...
        clickPlay = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(userPot < 100){
                    Toast.makeText(Jackpot.this, getString(R.string.minjackpot), Toast.LENGTH_SHORT).show();
                    return;
                }
            ...
            oButtonAddItem.setAlpha(0.7f);
                ...
                final int itemCount = 40 - oLLItemsArea.getChildCount();
                ...
                new CountDownTimer((itemCount+1)*100, 100){
                    ...
                    public void onTick(long millisUntilFinished) {
                        ...
                        int price = toolBox.getPriceFromString(quality,_db.getItemInfo(id,"PriceQuery"),stattrak);;


                        if(price + totalPot > userPot *100){
                            onFinish();
                        }
                    ...
                    public void onFinish() {
                        ...
                        while (index != 0){
                            ...
                            if(_chance <= intChance){
                                _list.add(1);
                                _scroolClass.addItem(_db.getAvatarUrl(Integer.parseInt(_db.getConfig("Avatar"))), _db.getConfig("UserName"), "%"+intChance, 2,true);
                            }else{
                                _list.add(0);
                        ...
                        oRLResultFather.setVisibility(View.INVISIBLE);
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                _db.setStatic("JACKPOT_GAME",1);

                                if(userPot > intMaxPot){
                                    _db.setStatic("JACKPOT_MAX_POT", userPot);
                                    intMaxPot = userPot;
                                }

                                if(_list.get(_scroolClass._index) == 1){
                                    boolWin = true;
                                }else{
                                    boolWin = false;
                                }
                                ...
                                if(boolWin){
                                    ...
                                    _db.setStatic("JACKPOT_WIN",1);
                                    _db.setStatic("JACKPOT_POT_WIN", totalPot);

                                    if(totalPot > intMaxGain){
                                        _db.setStatic("JACKPOT_MAX_GAIN", totalPot);
                                        intMaxGain = totalPot;
                                    }

                                    oIVStatus.setImageBitmap(toolBox.getBitmap("ui/win.png",0,0));
                                    oTxtChance.setText(getString(R.string.youwin));
                                    oTxtItemCount.setText("");
                                    ...
                                    //lose todo
                                    _db.setStatic("JACKPOT_LOSE",1);
                                    _db.setStatic("JACKPOT_POT_LOSE", totalPot);

                                    oIVStatus.setImageBitmap(toolBox.getBitmap("ui/quality5.png",0,0));
                                    oTxtChance.setText(getString(R.string.youlose));
                                    oTxtItemCount.setText("");
                                    Cursor _cr = _db.getJackpotItem();
                                ...
                                oIVStatus.startAnimation(_anim);
