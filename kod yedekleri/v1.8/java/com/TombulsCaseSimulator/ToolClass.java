...
public class ToolClass {
    ...
    public LinearLayout blankItem(){
        LinearLayout _child = new LinearLayout(context);
        LinearLayout.LayoutParams _size = new LinearLayout.LayoutParams(_pixelSize*65, _pixelSize*70,1f);
    ...
    public boolean gainXP(int XP){
        ...
        if(xp >= 5000 ){
            ...
            int currentLevel = Integer.parseInt(_db.getConfig("Level"));

            if(currentLevel != 40){
                 _db.setConfig("Level", String.valueOf(currentLevel+1));

                int currentXP = xp - 5000;

                _db.setConfig("XP", String.valueOf(currentXP));
    ...
    public Intent navigationSelect(int id){
        ...
        switch (id){
            ...
            case R.id.nav_crash:
                _intent = new Intent(context,Crash.class);
                break;
            ...
            case R.id.nav_contact:
                ...
                _intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"tombulsgames@gmail.com"});
