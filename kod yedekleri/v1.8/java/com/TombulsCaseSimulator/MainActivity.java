...
public class MainActivity extends AppCompatActivity
    ...
    public void checkUpdate(){
        ...
        if(Integer.parseInt(_db.getConfig("Version")) < 6){
            String Query = "1,610,2,741,4,71,5,26,7,100,11,109,17,87,19,29,179,4,207,122";
            String[] splitter =  Query.split(",");

            for(int i = 0; i < splitter.length; i = i + 2){
                _db.updateCasePrice(Integer.parseInt(splitter[0]), Integer.parseInt(splitter[1]));
            }

            _db.setConfig("Version", "6");
        }
    }
}
