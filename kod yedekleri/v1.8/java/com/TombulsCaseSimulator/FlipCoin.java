...
btnFunction.setAlpha(0.7f);
        ...
        intMaxGain = _db.getStatic("FLIP_COIN_MAX_GAIN");
        intMaxPot = _db.getStatic("FLIP_COIN_MAX_POT");
    }
    ...
    public void playFlip(){
        ...
        new CountDownTimer(2000,250){
            ...
            public void onFinish() {
                ...
                _db.setStatic("FLIP_COIN_GAME",1);

                if(value > intMaxPot){
                    _db.setStatic("FLIP_COIN_MAX_POT",value);
                }

                if(choose == 1){
                    _db.setStatic("FILIP_COIN_CHOOSE_CT",1);
                }else{
                    _db.setStatic("FILIP_COIN_CHOOSE_T",2);
                }
                ...
                if(_result){
                    ...
                    _color = R.color.win;
                    if(_subValue > intMaxGain){
                        _db.setStatic("FLIP_COIN_MAX_GAIN",_subValue);
                    }

                    _db.setStatic("FLIP_COIN_POW_WIN", _subValue);
                    _db.setStatic("FLIP_COIN_WIN",1);
                    ...
                    _db.setStatic("FLIP_COIN_POW_LOSE", _subValue);
                    _db.setStatic("FLIP_COIN_LOSE",1);
                }
